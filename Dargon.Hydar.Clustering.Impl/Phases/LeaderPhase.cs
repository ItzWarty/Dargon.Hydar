...
namespace Dargon.Hydar.Clustering.Phases {
   public class LeaderPhase : PhaseBase {
      ...
      public override void Enter() {
         ...
         var epochSummary = new EpochSummaryImpl(epochId, identity.NodeId, participants, epochTimeInterval);
         epochManager.EnterEpoch(epochTimeInterval, epochSummary, lastEpoch == null ? EpochSummaryImpl.kNullEpochSummary : lastEpoch.ToEpochSummary());
