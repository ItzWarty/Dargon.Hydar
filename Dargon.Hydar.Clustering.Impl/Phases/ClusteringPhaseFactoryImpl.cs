...
namespace Dargon.Hydar.Clustering.Phases {
   public class ClusteringPhaseFactoryImpl : ClusteringPhaseFactory {
      ...
      public ClusteringPhaseFactoryImpl(HydarIdentity identity, AuditEventBus auditEventBus, EpochManager epochManager, DebugEventRouter debugEventRouter, OutboundEnvelopeBus outboundEnvelopeBus, ClusteringConfiguration clusteringConfiguration, ClusteringMessageSender clusteringMessageSender, ClusteringPhaseManager clusteringPhaseManager) {
